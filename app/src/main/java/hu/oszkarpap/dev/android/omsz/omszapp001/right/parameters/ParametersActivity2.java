...
public class ParametersActivity2 extends MainActivity implements OnQueryTextListener {
    ...
    /**
     * this method fill adapter the medication and paramters
     * */
    ...
    /**
     * this method create the medication second paramters
     * */
    private void medString(int income) {
        ...
        atropin = 2 * progress / 100 + " mg iv. (0.02mg/ttkg, min 0.1mg)";
        ...
        epanutin = 15 * progress + " mg iv., max " + progress + "mg min (15mg/ttkg, max 1mg/ttkg/min)";
        etomidate = 15 * progress / 100 + " - " + 30 * progress / 100 + " mg iv.(0.3 mg/ttkg RSI ajánlás)";
        ...
        heparin = 50 * progress + " NE iv (50 NE/ttkg)";
        ...
        if (progress > 20) {
            double x = 20;
            ceftriaxon = 50 * x + " - " + 100 * x + " mg iv lassan (50-100mg/ttkg), max 2gr";
        } else {
            ceftriaxon = 50 * progress + " - " + 100 * progress + " mg iv lassan,(50-100 mg/ttkg) max 2gr";
        }
        rocuronium = progress / 4 + " mg - " + progress / 2 + " mg RSI után (0.25-0.5 mg/ttkg)," + progress + " mg iv.RSI-ben alt. izomrelaxánsként (1 mg/ttkg)";
        suxa = 1.5 * progress + " mg iv. RSI (1.5 mg/ttkg)";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.par_refresh) {
            finish();
            Intent intent = new Intent(ParametersActivity2.this, ParametersActivity2.class);
