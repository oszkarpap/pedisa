...
public class ChildActivity extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.bottom_adult:
                    intent = new Intent(ChildActivity.this,AdultActivity.class);
                ...
                case R.id.bottom_baby:
                    intent = new Intent(ChildActivity.this,BabyActivity.class);
                    startActivity(intent);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bottom_child);
    ...
    public boolean onOptionsItemSelected (MenuItem item){
        ...
        if (id == R.id.menu_medication) {
            intent = new Intent(ChildActivity.this, MedActivity.class);
            startActivity(intent);
        }
        ...
        if (id == R.id.menu_perfusor) {
            intent = new Intent(ChildActivity.this, PerfusorActivity.class);
            startActivity(intent);
        }
        if (id == R.id.menu_settings) {
            intent = new Intent(ChildActivity.this, LoginMainActivity.class);
            startActivity(intent);
        }
