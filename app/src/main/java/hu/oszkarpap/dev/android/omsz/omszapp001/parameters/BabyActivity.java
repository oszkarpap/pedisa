...
public class BabyActivity extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.bottom_adult:
                    intent = new Intent(BabyActivity.this,AdultActivity.class);
                    startActivity(intent);
                    return true;
                case R.id.bottom_child:
                    intent = new Intent(BabyActivity.this,ChildActivity.class);
                    startActivity(intent);
                    return true;
                case R.id.bottom_baby:
                    intent = new Intent(BabyActivity.this,BabyActivity.class);
                    startActivity(intent);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bottom_baby);
    ...
    public boolean onOptionsItemSelected (MenuItem item){
        ...
        if (id == R.id.menu_medication) {
            intent = new Intent(BabyActivity.this, MedActivity.class);
            startActivity(intent);
        }
        ...
        if (id == R.id.menu_perfusor) {
            intent = new Intent(BabyActivity.this, PerfusorActivity.class);
            startActivity(intent);
        }
        if (id == R.id.menu_settings) {
            intent = new Intent(BabyActivity.this, LoginMainActivity.class);
            startActivity(intent);
        }
        if (id == R.id.menu_log_out) {
            intent = new Intent(BabyActivity.this, MainActivity.class);
            startActivity(intent);
        }
