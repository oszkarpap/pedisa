    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_medication) {
            ...
            try {
                ...
                intent = new Intent(MainActivity_old.this, MedActivity.class);
        ...
        if (id == R.id.menu_parameters) {
            ...
            intent = new Intent(MainActivity_old.this, ParametersActivity.class);
            startActivity(intent);
        ...
        if (id == R.id.menu_settings) {
            Objects.requireNonNull(auth.getCurrentUser()).reload();
            intent = new Intent(MainActivity_old.this, LoginMainActivity.class);
            startActivity(intent);
        }
        ...
        if (id == R.id.menu_log_out) {
            ...
            alertDialogBuilder.setPositiveButton("Igen",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface arg0, int arg1) {
                            Toast.makeText(MainActivity_old.this, "Sikeresen kijelentkezett!", Toast.LENGTH_LONG).show();
                            auth.signOut();
                            finish();
                        }
                    });
            ...
            alertDialogBuilder.setNegativeButton("Nem", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    Toast.makeText(MainActivity_old.this, "Nem jelentkezett ki!", Toast.LENGTH_SHORT).show();
                }
            });
        ...
        if (id == R.id.menu_note) {
            Objects.requireNonNull(auth.getCurrentUser()).reload();
            intent = new Intent(MainActivity_old.this, MemoryActivity.class);
            startActivity(intent);
        }

        if (id == R.id.menu_rsi) {
            ifDelUser();
            intent = new Intent(MainActivity_old.this, RsiActivity.class);
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                if (childList.get(headerList.get(groupPosition)) != null) {
                    ...
                    switch (a) {
                        ...
                        case (0):
                            Objects.requireNonNull(auth.getCurrentUser()).reload();
                            Toast.makeText(MainActivity_old.this, "Sajnálom, nem implementáltam még a protokollt! Prehospitális vizsgálat sorrendje, Vénabiztosítás és az RSI működik!", Toast.LENGTH_LONG).show();
                        case (12):
                            Objects.requireNonNull(auth.getCurrentUser()).reload();
                            intent = new Intent(MainActivity_old.this, SOPActivity.class);
                            startActivity(intent);
                            break;
        ...
        konzBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (konzEt.getText().toString().length() < 8) {
                    Toast.makeText(MainActivity_old.this, "Biztos telefonszámot adott meg?", Toast.LENGTH_SHORT).show();
                } else {
                    FirebaseDatabase.getInstance().getReference()
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    Toast.makeText(MainActivity_old.this, "Firebase felhőbe mentve!", Toast.LENGTH_SHORT).show();
